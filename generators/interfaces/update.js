...
const updateCommandGenerator = (entity) => {
  ...
  import { ${names.uperFL}Entity } from '@${names.fileName}/domain/entities/${names.fileName}.entity';
  ...
  import { Update${names.uperFL}ResponseDTO } from '@${names.fileName}/interfaces/http/v1/update-${names.fileName}/dto/update-${names.fileName}.response';  
