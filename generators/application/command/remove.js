...
const removeCommandGenerator = (entity) => {
  ...
  import { ${names.uperFL}CommandsImplement } from '../../../infrastructure/repositories/${names.fileName}.repository';
  import { List${names.uperFL}sResponseDTO } from '../../../interfaces/http/v1/list-${names.fileName}s/dto/list-${names.fileName}s.response';
  import { Remove${names.uperFL}ResponseDTO } from '../../../interfaces/http/v1/remove-${names.fileName}/dto/remove-${names.fileName}.response';
